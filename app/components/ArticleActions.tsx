  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className={`p-3 sm:p-2 rounded-full transition-colors min-h-[44px] min-w-[44px] sm:min-h-[40px] sm:min-w-[40px] flex items-center justify-center ${isFavorite(article.url)
